...
{
	write_styles();
	writeln("<html><head><title>hapsascend Crapulent Quest Manager of Questing</title>");
	writeln("</head><body><h1>hapsascend Quest Manager</h1>");

	file_to_map("lh_ascend_quests.txt", s);
