...
/*
	This is a snippet of the zlib script, to provide the process_kmail function only (as lh_process_kmail to avoid conflicts)
*/
...
/*
//Now defined in lh_ascend_header.ash
record kmailObject
{
	int id;                   // message id
...
*/
void lh_process_kmail(string functionname)
{
