...
boolean tcrs_consumption()
{
	...
	if(get_property("lh_legacyConsumeStuff").to_boolean())
	{
		// print("Using a hard-coded consumption strategy for TCRS. 'set lh_legacyConsumeStuff=false' to use the new, cool automatic consumption strategy.", "red");
	}
	else
	{
