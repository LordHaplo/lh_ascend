...
boolean boris_buySkills()
{
	...
	if(my_level() <= get_property("lh_borisSkills").to_int())
	{
		return false;
	}
	...
	set_property("lh_borisSkills", my_level());
	return true;
}
